...
//       IndividualPlayer Novak = new IndividualPlayer("Nivak", false, new Record(76, 70));
      IndividualPlayer Roger = new IndividualPlayer("Roger", true, 100, 100);
      IndividualPlayer Rafael = new IndividualPlayer("Rafael", true, 88, 88);
      IndividualPlayer Novak = new IndividualPlayer("Nivak", false, 76, 70);
